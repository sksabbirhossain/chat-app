  ...
  return (
    <div className="flex h-screen flex-col overflow-hidden rounded-lg bg-white sm:h-[95vh]">
      ...
      <div className="flex items-center justify-between border-b border-gray-200 bg-white px-4 py-3 shadow-md">
        ...
        <button
          class="flex cursor-pointer items-center justify-end rounded-lg p-2 text-sm text-gray-500 ring-2 hover:bg-gray-100 focus:ring-2 focus:ring-gray-200 focus:outline-none sm:hidden"
