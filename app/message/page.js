  ...
  return (
    <div className="h-[95vh] w-full overflow-hidden rounded-lg bg-white">
      <div className="flex h-[55px] items-center justify-end pe-5 shadow">
        <button
          class="flex items-center justify-end rounded-lg p-2 text-sm text-gray-500 hover:bg-gray-100 focus:ring-2 focus:ring-gray-200 focus:outline-none sm:hidden"
      ...
      <div className="flex h-full flex-col items-center justify-center">
        <div className="flex flex-col items-center gap-1">
          ...
          <p className="text-center text-lg font-semibold text-gray-600 capitalize">
